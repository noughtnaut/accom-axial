...
public:
  ...
  Keymap() {
    ...
    keymap[2][0][1][0][0] = Key(String("[VID SWR]"));       // VID SWR
    keymap[2][0][1][0][1] = Key(String("[RTD]"));           // RTD
    keymap[2][0][1][0][2] = Key(String("[EFX]"));           // EFX
    keymap[2][0][1][0][3] = Key(String("[TBC]"));           // TBC
    keymap[2][0][1][0][4] = Key(String("[AUD SWR]"));       // AUD SWR
    keymap[2][0][1][0][5] = Key(String("[CCR]"));           // CCR
    keymap[2][0][1][0][6] = Key(String("[STIL]"));          // STIL
    keymap[2][0][1][0][7] = Key(String("[RTR]"));           // RTR
    keymap[2][1][0][0][0] = Key(String("[f5a3]"));
    keymap[2][1][0][0][1] = Key(String("[f5b3]"));
    keymap[2][1][0][0][2] = Key(String("[f5c3]"));
    keymap[2][1][0][0][3] = Key(String("[f5d3]"));
    keymap[2][1][0][0][4] = Key(String("[VID Menu 1]"));    // VID Menu 1
    keymap[2][1][0][0][5] = Key(String("[VID Menu 2]"));    // VID Menu 2
    keymap[2][1][0][0][6] = Key(String("[VID Menu 3]"));    // VID Menu 3
    keymap[2][1][0][0][7] = Key(String("[VID Menu 4]"));    // VID Menu 4
    keymap[2][0][0][0][0] = Key(String("[VID Menu 5]"));    // VID Menu 5
    keymap[2][0][0][0][1] = Key(String("[VID Menu 6]"));    // VID Menu 6
    Serial.print("ok ");
  }
};
