...
/*
 * Note:
 * "Arduino has very limited support for the C++ standard library functions.
 * You can expect most C++ std namespace stuff to not work."
 * source: PaulStoffregen at https://forum.pjrc.com/threads/46866-string-help?p=155978&viewfull=1#post155978
 */
